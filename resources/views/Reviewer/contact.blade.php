...
<html lang="en">
    ...
    <!-- Site Icons -->
    <link rel="shortcut icon" href="employee_css/images/favicon.ico" type="image/x-icon" />
    <link rel="apple-touch-icon" href="employee_css/images/apple-touch-icon.png">

    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="employee_css/css/bootstrap.min.css">
    <!-- Site CSS -->
    <link rel="stylesheet" href="employee_css/style.css">  
    <!-- Responsive CSS -->
    <link rel="stylesheet" href="employee_css/css/responsive.css">
    <!-- Custom CSS -->
    <link rel="stylesheet" href="employee_css/css/custom.css">

    <!-- Modernizer for Portfolio -->
    <script src="employee_css/js/modernizer.js"></script>
...
<body>
    ...
    <!-- ALL JS FILES -->
    <script src="employee_css/js/all.js"></script>
    <!-- ALL PLUGINS -->
    <script src="employee_css/js/custom.js"></script>
    <script src="employee_css/js/portfolio.js"></script>
    <script src="employee_css/js/hoverdir.js"></script>    
