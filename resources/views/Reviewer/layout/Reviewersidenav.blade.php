 <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="{{asset('https://demos.creative-tim.com/material-dashboard/pages/dashboard')}}" target="_blank">
        <img src="{{asset('../Reviewer/img/logo-ct.png')}}" class="navbar-brand-img h-100" alt="main_logo">
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item ">
          <a class="{{ (request()->is('/Reviewer_showActualEvaluations')) ? 'nav-link text-white active bg-gradient-primary' : 'nav-link text-white' }}" href="{{url('/Reviewer_showActualEvaluations')}}">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons opacity-10">receipt_long</i>
            </div>
            <span class="nav-link-text ms-1">عرض التقييمات الفعلية للمستخدمين</span>
          </a>
        </li>
        <li class="nav-item ">
          <a class="{{ (request()->is('/Reviewer_showSelfEvaluations')) ? 'nav-link text-white active bg-gradient-primary' : 'nav-link text-white' }}" href="{{url('/Reviewer_showSelfEvaluations')}}">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons opacity-10">receipt_long</i>
            </div>
            <span class="nav-link-text ms-1">عرض التقييمات الذاتية للمستخدمين</span>
          </a>
        </li>
        {{-- <li class="nav-item ">
          <a class="{{ (request()->is('/Show_UserEvaluations')) ? 'nav-link text-white active bg-gradient-primary' : 'nav-link text-white' }}" href="{{url('/Show_UserEvaluations')}}">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons opacity-10">receipt_long</i>
            </div>
            <span class="nav-link-text ms-1">عرض جميع التقييمات</span>
          </a>
        </li> --}}
