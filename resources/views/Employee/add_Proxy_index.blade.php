    ...
    <div style="margin-top: 100px;margin-bottom: 50px;"  class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="contact_form">
                <div id="message"></div>
                <form id="contactform" class="row" action="{{url('store_proxy')}}" name="contactform" method="POST">
                    <fieldset class="row-fluid">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <label class="sr-only">اختر كود المستخدم</label>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <label class="sr-only">رقم التوكيل</label>
                            <input type="text" name="proxy_num" id="first_name" class="form-control" placeholder="رقم التوكيل" required>
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <label class="sr-only">مكتب التوثيق</label>
                            <input type="text" name="office_doc" id="last_name" class="form-control" placeholder="مكتب التوثيق" required>
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <label class="sr-only">نوعه</label>
                            <input type="text" name="proxy_type" id="phone" class="form-control" placeholder="نوعه" required>
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <label class="sr-only">التاريخ</label>
                            <input type="text" name="time" id="phone" class="form-control" placeholder="التاريخ" required>
                        </div>
