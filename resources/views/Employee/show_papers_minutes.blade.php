    ...
    <div style="margin-top: 100px;margin-bottom: 50px;"  class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="contact_form">
                ...
                <table id="customers">
                    <tr>
                        <th style="text-align: center" >قلم المحضرين</th>
                    ...
                    @foreach ($Papers_data as $item)
                        <tr>
                            <td>$item->minutes_pen</td>
                            <td>$item->user_code</td>
                            <td>{{$item->user_name}}</td>
                            <td>$item->recieve_time</td>
                            <td>$item->session_time</td>
                            <td><a href="{{url('papers_delet/'.$item->id)}}" >حذف</a></td>
