  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <div class="card" style="width: 80%;margin-left:10%;">
        ...
        <div style="text-align:right;" class="card-header">
           ...
           <a href="{{url('/question/selectedgroup',$question->group->id)}}" class="btn btn-success">عودة الي الصفحة السابقة</a>
           <br>
           <h4>تعديل السؤال</h4>
        ...
        <div class="card-body" >
            <form action="{{url('/updatequestion',$question->id)}}" method="POST" enctype="multipart/form-data">
              @csrf
               <div class="row">
                <div class="col-md-12 mb-3" >
                    <div style="text-align:right" class="col-md-12 mb-3">
                        <label>نص السؤال</label>
                            <input type="text" style="background-color:OldLace;text-align:right"  class="form-control" value="{{$question->question_text}}"  name="question_text" required/>
                            @error('question_text')
                            <div class="alert alert-danger">
                                {{$message}}
                            </div>
                        ...
                        <label>وزن المجموعة</label>
                            <input type="text" style="background-color:OldLace;text-align:right" class="form-control" value="{{$question->question_score}}"  name="question_score" required/>
                    ...
                    <div style="text-align:right;">
                        <label >نوع الاجابة</label>
                    </div>
                    <select class="form-select" name="question_resultstatus"  aria-label="Default select example" style="text-align: right" required>
                        <option value="1">نعم او لا</option>
                  ...
                  <input type="text" style="background-color:OldLace;text-align:right"  class="form-control" value="{{$question->group->id}}"  name="group_id" hidden/>
