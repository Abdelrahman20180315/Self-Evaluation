              ...
              @csrf
               <div class="row">
                    <div class="col-md-12 mb-3" >
                      <select class="form-select" name="program_id" aria-label="Default select example" style="text-align: right" required>
                    ...
                    <label>أسم المجموعة</label>
                        <input type="text" style="background-color:OldLace;text-align:right" class="form-control"  name="group_name" required/>
                        @error('group_name')
                        <div class="alert alert-danger">
                            {{$message}}
                        </div>
                    ...
                    <label>وزن المجموعة</label>
                        <input type="text" style="background-color:OldLace;text-align:right" class="form-control"  name="group_score" required/>
                        @error('group_score')
                            <div class="alert alert-danger">
                                {{$message}}
                            </div>
