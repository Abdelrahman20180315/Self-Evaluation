  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <div class="card" style="width: 80%;margin-left:10%;">
        <div style="text-align:right;" class="card-header">
           <h4>إضافة فهرس التوكيلات</h4>
        </div>
        <div class="card-body" >
            <form action="{{url('admin_store_proxy')}}" method="POST" enctype="multipart/form-data">
              @csrf
               <div class="row">
                    ...
                    <label>رقم التوكيل</label>
                        <input type="text" style="background-color:OldLace;text-align:right" class="form-control"  name="proxy_num" />
                    ...
                    <label>مكتب التوثيق</label>
                        <input type="text" style="background-color:OldLace;text-align:right" class="form-control"  name="office_doc" />

                    </div>
                    <div style="text-align:right" class="col-md-12 mb-3">
                        <label>نوعه</label>
                        <input type="text" style="background-color:OldLace;text-align:right" class="form-control"  name="proxy_type" />

                    </div>   
                    <div style="text-align:right" class="col-md-12 mb-3">
                        <label>التاريخ</label>
                        <input type="text" style="background-color:OldLace;text-align:right" class="form-control"  name="time" />
                    </div>   
