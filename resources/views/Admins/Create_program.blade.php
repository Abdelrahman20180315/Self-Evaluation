              ...
              @csrf
               <div class="row">
                    ...
                    <div style="text-align:right;" class="col-md-12 mb-3">
                          <label>حالة المنظمة او الشركة</label>
                          <select class="form-select" name="organization_status" style="text-align:right;" aria-label="Default select example">
                    ...
                    <label>صفة الموكل</label>
                        <input type="text" style="background-color:OldLace;text-align:right" class="form-control"  name="user_details" />

                    </div>
                    <div style="text-align:right;" class="col-md-12 mb-3">
                        <label>الخصم و صفتة</label>
                        <input type="text" style="background-color:OldLace;text-align:right" class="form-control"  name="enemy_details" />

                    </div>   
                    <div style="text-align:right;" class="col-md-12 mb-3">
                        <label>أخر جلسة</label>
                        <input type="text" style="background-color:OldLace;text-align:right" class="form-control"  name="last_session" />
                    </div>   
                    <div style="text-align:right;" class="col-md-12 mb-3">
                        <label>القرار</label>
                        <input type="text" style="background-color:OldLace;text-align:right" class="form-control"  name="decesion" />
                    </div> --}}
                    <div style="text-align:right;" class="col-md-12 mb-3">
