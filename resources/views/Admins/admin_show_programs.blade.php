    ...
    <div class="card my-4">
      <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
        <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
          ...
          <h6 class="text-white text-capitalize ps-3">جدول البرامج</h6>
        </div>
      </div>
          ...
          <table class="table align-items-center justify-content-center mb-0">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <span class="text-xs font-weight-bold"><a href="{{url('/creategroups/selectedprgram',$program->id)}}">{{$program->program_name}}</a></span>
                </td>
                <td>
                  <a href="{{route('program.edit', $program->id)}}" class="btn btn-success">Edit</a>
                </td>
