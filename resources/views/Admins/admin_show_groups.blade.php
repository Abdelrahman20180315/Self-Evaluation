  ...
  <div  class="col-12">
      <div style="text-align:right" class="col-md-12 mb-3">
        <form action="{{route('group.search')}}" method="GET">
          <input type="text" style="background-color: white;text-align:right;border-radius: 16px;width:80%;float:right;margin-right: 2%;font-size:25px" class="form-control" placeholder="...ابحث"  name="searchgroup" />
        </form>
    <br>
    <br>
      </div>
      ...
      <div class="card-body px-0 pb-2">
        ...
        <div class="table-responsive p-0">
          <table class="table align-items-center justify-content-center mb-0">
            <thead>
              <tr>
                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">اسم المجموعة</th>
                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">وزن المجموعة</th>
                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">البرنامج التي تنتمي اليه المجموعة</th>
                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">اكشن 1</th>
                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">اكشن 2</th>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                    <span class="text-xs font-weight-bold">{{$group->program->program_name}}</span>
                </td>
                <td>
                ...
                <td class="align-middle">
                  {{-- <a href="{{route('program.destroy',$program->id)}}" class="btn btn-danger">
                    Delete
                  </a> --}}
