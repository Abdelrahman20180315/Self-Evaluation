    ...
    <div class="card" style="width: 80%;margin-left:10%;">
      ...
      @endif
        <div style="text-align:right;" class="card-header">
           <h4>تعديل حالة الشركةاو المنظمة </h4>
        </div>
        <div class="card-body" >
            <form action="{{url('/update_organizationstatus',$organization->id)}}" method="POST" enctype="multipart/form-data">
              @csrf
               <div class="row">
                    <div style="text-align:right;" class="col-md-12 mb-3">
                        <label>ادخال حالة الشركة او المنظمة</label>
                        <input  type="text" style="background-color:OldLace;text-align:right" class="form-control" value="{{$organization->organization_status}}"  name="organization_status" />
