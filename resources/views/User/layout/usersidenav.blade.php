 <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/material-dashboard/pages/dashboard " target="_blank">
        <img src="../Userfront/img/logo-ct.png" class="navbar-brand-img h-100" alt="main_logo">
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item ">
          <a class="{{ (request()->is('/userhomepage')) ? 'nav-link text-white active bg-gradient-primary' : 'nav-link text-white' }}" href="{{url('/userhomepage')}}">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons opacity-10">receipt_long</i>
            </div>
            <span class="nav-link-text ms-1">إجراء تقييم</span>
          </a>
        </li>
        <li class="nav-item ">
          <a class="{{ (request()->is('/Show_UserEvaluations')) ? 'nav-link text-white active bg-gradient-primary' : 'nav-link text-white' }}" href="{{url('/Show_UserEvaluations')}}">
            ...
            <span class="nav-link-text ms-1"> عرض جميع التقييمات الذاتية للمستخدم</span>
          </a>
        </li>
        <li class="nav-item ">
          <a class="{{ (request()->is('/Show_UserActualEvaluations')) ? 'nav-link text-white active bg-gradient-primary' : 'nav-link text-white' }}" href="{{url('/Show_UserActualEvaluations')}}">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons opacity-10">receipt_long</i>
            </div>
            <span class="nav-link-text ms-1"> عرض جميع التقييمات الفعلية للمستخدم</span>
          </a>
        </li>
