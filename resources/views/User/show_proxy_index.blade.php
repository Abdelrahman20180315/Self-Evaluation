            ...
            <div class="contact_form">
                ...
                <table id="customers">
                    <tr >
                        ...
                        <th style="text-align: center" >رقم التوكيل</th>
                        <th style="text-align: center" >اسم الموكل</th>
                        <th style="text-align: center" >مكتب التوثيق</th>
                        <th style="text-align: center" >نوعه</th>
                        <th style="text-align: center" >التاريخ</th>
                        
                        <th style="text-align: center" >اكشن</th>
                    </tr>
                    @foreach ($Proxy_data as $item)
                        <tr>
                            <td>$item->user_code</td>
                            <td>$item->proxy_num</td>
                            <td>{{$item->user_name}}</td>
                            <td>$item->office_doc</td>
                            <td>$item->proxy_type</td>
                            <td>$item->time</td>
                            <td><a href="{{url('proxy_delet/'.$item->id)}}" >حذف</a></td>
